...
const readData = async () => {
	...
	createChart(data, "attacker_jurisdiction");

	//////////////////////////// dropdown ///////////////////////////////////////

	d3.select("#dropdown").on("change", function () {
		var sect = document.getElementById("dropdown");
		let sel = sect.options[sect.selectedIndex].value;
		console.log(sel);
		createChart(data, sel);
	});
